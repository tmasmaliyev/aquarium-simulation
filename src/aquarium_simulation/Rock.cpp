...
Rock::Rock()
{
	...
	x = random(-10.0f, 10.0f);
	y = Y / 3;
	z = random(-10.0f, 10.0f);
	sx = random(0.1f, 0.5f);
	sy = Y;
	sz = random(0.1f, 0.5f);
	...
	std::string path_obj = "./assets/Models/Rock01.obj";
	...
	std::string path_tex;
	if (textureNo == 0)
		path_tex = "./assets/Models/Rock01.jpg";
	else if (textureNo == 1)
		path_tex = "./assets/Models/Rock02.jpg";
