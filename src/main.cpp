...
#include "aquarium_simulation/Lights.h"
#include "aquarium_simulation/Shader.h"
#include "aquarium_simulation/Camera.h"
#include "aquarium_simulation/Floor.h"
...
int main()
{
	...
	// Cross-platform timing using chrono
	auto next_game_tick = std::chrono::steady_clock::now();
	const auto skip_duration = std::chrono::milliseconds(SKIP_TICKS);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		next_game_tick += skip_duration;
		auto now = std::chrono::steady_clock::now();
		auto sleep_time = std::chrono::duration_cast<std::chrono::milliseconds>(next_game_tick - now);
